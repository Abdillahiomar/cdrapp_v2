...
class TransactionsExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithChunkReading
{
    private int $counter = 0;

    /**
     * @param \Illuminate\Database\Eloquent\Builder $query  La REQUÊTE (non exécutée)
     */
    public function __construct(protected $query) {}

    public function query()
    {
        // Laravel Excel exécute la requête par chunks, jamais tout en mémoire.
        // Eager loading pour éviter le N+1 sur le libellé du type.
