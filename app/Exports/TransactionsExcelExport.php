...
class TransactionsExcelExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithChunkReading
{
    ...
    {
        return [
            '#', 'Date', 'Transaction ID', 'Statut', 'Canal', 'Reason','Transaction Type', 
            'Debit Party', 'Debit Balance Avant', 'Debit Balance Apres', 
            'Credit Party', 'Credit Balance Avant', 'Credit Balance Apres',
